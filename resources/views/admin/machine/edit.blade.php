...
@section('content')
<form action="{{url('admin/machine/update')}}" method="post" autocomplete="off" id="form">
    @csrf
    ...
    <div class="card card-custom gutter-b example example-compact">
        <div class="card-header bg-pro">
            <h3 class="card-title color-white">Account List > @if($user->accountSetting->account_poc!='') {{$user->accountSetting->account_poc}} @else {{$user->email}} @endif > Edit Machine</h3>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input  type="text" name="kiosk_identifier" class="form-control confirm" placeholder="" value="{{$kiosk->kiosk_identifier}}" id="kiosk_identifier" maxlength="30" autocomplete="new-kiosk_identifier" required="" onclick="checkMachineNameConfirmation()">
                </div>
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <label class="col-form-label">{{__('labels.PASSWORD')}}<span class="error">*</span></label>
                     <span class="float-right mt-2" onclick="randomPassword(8);" style="cursor: pointer;">
                        <i class="la la-refresh refresh-icon"></i> 
                        <span>Regenerate Password</span>
                    </span>
                    <div class="custom-pwd">
                        <input type="text" name="kiosk_password" id="password" class="form-control confirm" placeholder=""  value="{{$kiosk->kiosk_password}}" minlength="6" maxlength="30" autocomplete="new-password" onclick="checkPConfirmation()">
                ...
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input type="text" name="" class="form-control" value="{{$kiosk->template_name}}"  maxlength="100" readonly="">
                </div>
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <label class="col-form-label">{{__('labels.FACIAL_DETECTION')}}<span class="error">*</span></label>
                    <input type="text" name="kiosk_facial_license" class="form-control" value="{{$kiosk->kiosk_facial_license}}"  maxlength="100">
                </div>
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <label class="col-form-label">{{__('labels.MACHINE_SERIAL')}} </label>
                    <input  type="text" name="kiosk_serial_no" class="form-control" value="{{$kiosk->kiosk_serial_no}}"  maxlength="30" placeholder="{{__('labels.MACHINE_SERIAL')}}">
                </div>   
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input type="text" name="pos_pin" class="form-control" value="{{$kiosk->pos_pin}}" maxlength="100" required="" id="pos_pin">
                </div>  
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input type="number" name="kiosk_zip" class="form-control" value="{{$kiosk->kiosk_zip}}"  maxlength="50" required="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">        
                ...
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input  type="number" name="kiosk_tax_rate" class="form-control" value="{{$kiosk->kiosk_tax_rate}}"  maxlength="30"  >
                </div>   
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    ...
                    <input type="radio" id="yes" name="pos_age_regulation" value="Y" @if($kiosk->pos_age_regulation == 'Y') checked @endif>
                    <label for="yes">Yes</label> &nbsp;&nbsp;
                    <input type="radio" id="no" name="pos_age_regulation" value="N" @if($kiosk->pos_age_regulation!= 'Y') checked @endif>
...
@section('scripts')
    ...
    <script type="text/javascript">
        @if($promotions->isNotEmpty() && !empty($kiosk_promo_id))
            var c = '<?php echo $kiosk_promo_id ;?>';
            var promo = c.split(',');
