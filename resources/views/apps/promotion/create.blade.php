...
<form action="{{url('app/promotion/save')}}" method="post" autocomplete="off" id="form">
    @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header bg-pro">
                    <h3 class="card-title color-white">Add Promotion</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                            <div class="form-group">
                                ...
                                <input  type="text" name="promo_code" class="form-control" placeholder=""  value="{{old('promo_code')}}" maxlength="50" autocomplete="new-promo_code" required="">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">{{__('labels.PROMO_DESC')}} </label>
                                <textarea type="text" name="promo_cart_desc" class="form-control" value="" maxlength="500" rows="3">{{old('promo_cart_desc')}}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">{{__('labels.PROMO_MSG')}}</label>
                                <textarea  name="promo_optin_message" id="promoMsg" class="form-control" value=""  maxlength="200" rows="2">{{old('promo_optin_message')}}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">{{__('labels.PROMO_DISCOUNT')}} <span class="error">*</span></label>
                                <input  type="number" name="promo_discount" id="promo_disc" class="form-control" placeholder=""  value="{{old('promo_discount')}}" maxlength="50" autocomplete="new-promo_discount" required="" min=0 max="100" step="1">
                            </div>
                            <div class="form-group">
                                ...
                                <select  name="promo_status" class="form-control" required="">
                                    ...
                                    <option value="N" @if(old('promo_status' ) == 'N') selected="" @endif>Inactive</option>
                                    <option value="Y" @if(old('promo_status' ) == 'Y') selected="" @endif>Active</option>
                                </select>
                            </div>    
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" >
                                ...
                                <div class="promotions-add_formBlock" style="border:1px solid #ccc">
                                    <div class="text-center modal-body">
                                        ...
                                        <h1 id="promo_perc" class="mb-5">
                                            <strong><span id="promo_discount"></span>%</strong>
                                        </h1>
